...
/*  xx-xx-xxxx     Bhupendra Naphade        Modified comment(s),updated   */ 
/*                                            macro definition,           */ 
...
#define TX_INTERRUPT_SAVE_AREA                  register int interrupt_save;
#define TX_DISABLE                              asm volatile ("csrrci %0,mstatus,8": "=r" (interrupt_save));
#define TX_RESTORE                              asm volatile ("csrw mstatus,%0"  :: "r" (interrupt_save));
...
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) Microsoft Corporation. All rights reserved.  *  ThreadX RISC-V32/IAR Version G6.x *";
#else
